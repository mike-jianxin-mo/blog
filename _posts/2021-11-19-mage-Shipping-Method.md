---
title: Magento - Add a new Shipping Method
author: Mike Mo
date: 2021-11-19
category: Magento
layout: post
...
- Define the join in <strong>config.xml</strong>. 
- With the <couriers/> element.
- Implement the <strong>collectRates</strong> function in the Shipment Class
...
### Hide/Show - The Plugin Way
di.xml
```
<?xml version="1.0"?>
<config xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="urn:magento:framework:ObjectManager/etc/config.xsd">
    <type name="Magento\Quote\Model\Quote\Address">
        <plugin name="abcShippingAddressPlugin" type="Abc\Shipping\Plugins\Quote\Address"/>
    </type>
</config>
```
